         ...
         <header class="header_section">
            <div class="container">
               <nav class="navbar navbar-expand-lg custom_nav-container ">
                  <a class="navbar-brand" href="index.html"><img width="250" src="{{url('/images/')}}/logo.png" alt="#" /></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav">
                       ...
                       <li class="nav-item dropdown">
                        ...
                        <li class="nav-item">
                           <a class="nav-link" href="{{route('front.blog_list')}}">Blog</a>
                        </li>
                        <li class="nav-item">
                        ...
                        @if(Session::get('logindata'))
                           ...
                           @else
                              ...
                              <li class="nav-item">
                                 <a class="nav-link" href="{{route('front.registration')}}">Register</a>
                              </li>
                            @endif
                        <li class="nav-item">
                           <a class="nav-link" href="{{route('front.card')}}">
